...
# nucmer --maxmatch --prefix=efaecium_comparison \
# /home/mariagad/GenomeAnalysis/data/01_Assembly/pacbio_assembly/efaecium.contigs.fasta \
# /home/mariagad/GenomeAnalysis/data/02_Annotation_downstream_analyses/sinteny/sequences/GCF_000393015.1_Ente_faec_T5_V1_genomic.fna

# Step 2: Filter alignments to keep only long, clean matches
# delta-filter -1 efaecium_comparison.delta > efaecium_comparison.filtered.delta

# Step 3: Generate plot
# mummerplot --png -p efaecium_plot efaecium_comparison.filtered.delta
